...
watch(() => props.item.element, (element) => {
  hoverSelector.value = element ? simpleElementSelector(element) : '';
})
...
<template>
  <div class="app-canvas__inspect fixed pointer-events-none z-1" :style :data-tag="hoverSelector" :class="{
    'app-canvas__inspect--active': active,
  }">
    <svg width="100%" height="100%">
      <rect width="100%" height="100%" fill="none" stroke="white" stroke-width="2" stroke-dasharray="4" />
    </svg>
  </div>
</template>
